      ...
      <tr>
        ...
        <td style='width:40%;'>
          <table style='width:100%;'>
            ...
            <tr>
              <td colspan='2'><br/><b><u>Complete upon arrival in France:</u></b></td>
            </tr>

            <tr>
              <td>French phone number</td>
              <td>
                @if ($edit)
                  <input type='text' name='frenchphone' value='{{ $student->frenchphone }}'/>
                @else
                  {{ $student->frenchphone }}
                @endif
              </td>
            ...
            <tr>
              <td>Phone number used on WhatsApp</td>
              <td>
                @if ($edit)
